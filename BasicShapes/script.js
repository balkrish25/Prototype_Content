document.addEventListener('DOMContentLoaded', () => {
    ...
    // 🎵 Load audio files
    const voiceIntro = new Audio('./Assets/Audios/introBasicShapes.mp3');
    const clapSound = new Audio('./Assets/Audios/applause.mp3');
    const successSound = new Audio('./Assets/Audios/good.mp3');
